...
const ptHandler = function (str, preserveLineBreaks) {
  ...
  // General global replace support and quick fixes for Plain Text
  temp5 = temp5.replace(/track\(/gi, 'track("');
  temp5 = temp5.replace(/’/i, "\'");
  temp5 = temp5.replace(/&raquo;/i, ">>");
...
const orphanHandler = function (str) {
  ...
  // Handle French and any language that include a space before the ending colon
  str = str.replace(/ :/gi, "~~");
  ...
  // Restore French and any language that include a space before the ending colon
  temp5 = temp5.replace(/~~/gi, "&nbsp;:");
